...
Competição de quatro em uma linha (\emph{Four-in-a-row}) - Versão 2013/2}
\author{Prof. Fabrício Jailson Barth\\
Sistemas Inteligentes\\
Faculdade de Tecnologia \textsc{BandTec}}
\date{$2^{o}$. semestre de 2013}
...
equipes, um jogador \emph{aleatório} e outros três jogadores vencedores de
semestres anteriores. Informações sobre como os três jogadores
...
O jogador que provocar \emph{looping}
...
desenvolveu o jogador. Cada equipe poderá ser formada por até quatro
pessoas.
...
Os outros jogadores participantes da competição são: \textbf{Alastor},
\textbf{IdeiaFix} e \textbf{MDF}. Todos os relatórios sobre como os jogadores foram desenvolvidos
...
um jogador que sempre ganha este jogo.
