...
public class JogadorAlastor implements Jogador
{
	...
	public String getNome(){ return "Alastor"; }
	...
	** peso diferente dependendo do numero de pcas em conjunto */
	...
	/**
	*** as funcoes *Score contam quantas possibilidades de vitoria
	*** ha numa determinada posicao para um determinado jogador,
	*** apenas levando em consederacao conjuntos em aberto, ou seja
	*** se eu procuro por conjuntos de 3:
	*** retona o numero de conjuntos com 3 pcas e 1 espaço para jogar
	*** se eu procuro por conjuntos de 2:
	*** retona o numero de conjuntos com 2 pcas e 2 espaços para jogar
	*** se eu procuro por conjuntos de 4:
	*** retona o numero de conjuntos com 4 pcas, nao considera espaços
	**/
	...
	** existem para o jogador color na diagonal */
	...
	public static void main(String[]ar)
	{
		...
		JogadorAlastor j = new JogadorAlastor();
